  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Wrap(
        ...
        runSpacing: 24,
        children: [
          _buildOption(context, Icons.image, 'Gallery', onGallery, Colors.purple),
          _buildOption(context, Icons.insert_drive_file, 'Document', onDocument, Colors.blue),
          _buildOption(context, Icons.camera_alt, 'Camera', onCamera, Colors.green),
