        ...
        data: (orders) => orders.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final productName = (order as dynamic).store_name ?? 'Product';
                    ...
                    child: Row(
                      children: [
                        ClipRRect(
                          ...
                          child: productImage != null && productImage.isNotEmpty
                              ...
                              : Container(
                                  ...
                                  height: 80,
                                  color: kGrey,
                                  child: const Icon(Icons.image, color: kWhite, size: 40),
                                ),
                        ),
                        Expanded(
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('₹${price.toStringAsFixed(0)}', style: kLargeTitleSB),
                              ],
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Text('Quantity: $quantity', style: kBodyTitleR),
                        ),
                      ],
                    ),
                  );
