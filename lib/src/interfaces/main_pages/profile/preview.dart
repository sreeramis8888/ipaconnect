...
class ProfilePreview extends ConsumerStatefulWidget {
  final UserModel user;
  const ProfilePreview({Key? key, required this.user}) : super(key: key);

  @override
  ConsumerState<ProfilePreview> createState() => _ProfilePreviewState();
}
